...
void main() {
  Widget buildSubject() {
    final friend = const FriendProfile(
      userId: 'friend-1',
      nickName: '친구러너',
      friendCode: 'FRIEND01',
    );
    final crew = const CrewSummary(
      id: 'crew-1',
      name: '강남 러너스',
      region: '강남',
      memberCount: 12,
    ...
    return MaterialApp(
      home: SocialPage(
        ...
        loadCrewDetail:
            (_, {seasonType = 'week', anchorDate, memberLimit = 50}) async =>
                CrewDetail(
                  season: const CrewSeason(
                    seasonType: 'week',
                    anchorDate: '2026-06-01',
        ...
        leaveCrew: (_) async => CrewMutationResult(status: 'left', crew: crew),
