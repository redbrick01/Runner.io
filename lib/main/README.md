...
| `statistics_page.dart` | 주간/월간/전체 러닝 요약, 최근 7일 거리 그래프, 이전 기간 대비 변화, 개인 최고 기록 표시 |
...
- 현재 `statistics_page.dart`의 분석은 저장된 러닝 기록을 클라이언트에서 집계하는 기능입니다. AI 챗봇 기반 자연어 분석은 별도 향후 기능입니다.
